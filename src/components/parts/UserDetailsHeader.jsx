 ...
 * @param {Object} user - An object containing the user details like name, email,
 *                        phone, website, company, address
 * @returns {JSX.Element} - A React element that renders a user profile icon, name,
 *                          email, phone, website, company, and address
 */
